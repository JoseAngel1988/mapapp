...
# Cargar datos
data = pd.read_excel('C:/Users/Jose Angel/Desktop/Proyectos_Practica/mapapp/alertaDeforestacion2021.xlsx')
print(data.describe())
...
for lat, lon in zip(latitud, longitud):
    folium.Marker([2.48, -72.41], popup='Área deforestada').add_to(mi_mapa)
    ...
    folium.Marker([2.39, -73.33], popup='Área deforestada').add_to(mi_mapa)
